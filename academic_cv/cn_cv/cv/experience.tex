...
\cventry
{作者} % Job title
{免训练的基于条件的分子生成} % Organization
{论文} % Location
{2023.09-2023.10} % Date(s)
{
...
{基于扩散的图生成模型综述} % Organization
{论文(投稿至TKDE)} % Location
{2023.02-2023.08} % Date(s)
{
  \begin{cvitems} 
...
%     \item {该文章 “Pursuit and Evasion Strategy of a Differential Game Based on Deep Reinforcement Learning” 发表于期刊 (中科院二区 / JCR Q1) Frontiers in Bioengineering and Biotechnology 。}
%   \end{cvitems}
% }
